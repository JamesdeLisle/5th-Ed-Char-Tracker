...
def dispInt(y,x,key,names,indentation,stdscr):
    ...
    while go_flag:
        ...
        stdscr.addstr(y+2,indentation,'%s: ' % (statement))
        stdscr.refresh()
        choice = stdscr.getstr(y+2,indentation+len(statement)+2)
...
def dispMLst(y,x,key,indentation,stdscr,lists):
    ...
    while input_flag:
        ...
        stdscr.addstr(6 + count,indentation,statement)
        stdscr.refresh()
...
def dispBool(y,x,key,names,indentation,stdscr):
    ...
    while choice_flag:
        ...
        statement = 'Pick a number: '
        stdscr.addstr(y+7,indentation,statement)
        stdscr.refresh()
        choice = stdscr.getstr(y+7,indentation+len(statement))
        try:
            test = int(choice)
